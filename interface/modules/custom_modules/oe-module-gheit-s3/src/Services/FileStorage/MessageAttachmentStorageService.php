 ...
 *
 * Entry point for MessageService.php to persist a patient-portal or
 * internal message attachment through the shared storage layer instead
 * of writing to local disk. Attachments live under the "communications"
 * prefix (not tied to a patient folder) since a message thread can span
 * staff-to-staff communication with no patient context at all.
 *
