 ...
 * FileMetadataService
 *
 * Thin orchestration layer over FileMetadataRepositoryInterface. Kept
 * separate from the repository so callers depend on a stable service
 * contract while the persistence mechanism (currently SqlFileMetadataRepository)
 * can be swapped in tests or future storage backends.
 *
